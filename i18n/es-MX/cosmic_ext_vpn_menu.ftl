...
reason-login-failed = falló la autenticación
detail-dns = DNS
...
ovpn-key-dir = Dirección de la clave
...
vpnc-domain = Dominio
vpnc-nat = Recorrido NAT
vpnc-pfs = Confidencialidad directa perfecta
vpnc-dh = Grupo DH
vpnc-vendor = Proveedor
vpnc-app-version = Versión de la aplicación
vpnc-single-des = Habilitar el cifrado débil DES simple
